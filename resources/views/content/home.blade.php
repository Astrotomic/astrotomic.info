...
@section('content')
    ...
    <section class="bg-treeware-500 relative">
        ...
        <div class="container mx-auto pr-4 mb-8 flex flex-wrap">
            <img src="https://img.shields.io/badge/License-MIT-blue?style=for-the-badge" class="ml-4" />
            <img src="https://img.shields.io/badge/Treeware-%F0%9F%8C%B3-lightgreen?style=for-the-badge" class="ml-4" />
        </div>
        <div class="container mx-auto px-4 flex flex-col md:flex-row">
            ...
            <div class="md:w-1/3 mt-4 md:mt-0">
                <a href="https://offset.earth/treeware">
                    <img src="https://toolkit.offset.earth/carbonpositiveworkforce/badge/5e186e68516eb60018c5172b?white=true&landscape=true" />
                </a>
            </div>
        </div>
