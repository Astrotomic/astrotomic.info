<div class="mb-2 divided">
    <span>
        <x-elements.icon icon="fa-code" icon-style="fas" class="opacity-75" />
        {{ $package['language'] }}
    </span>
    <span>
        <x-elements.icon icon="fa-star" icon-style="fas" class="opacity-75" />
        <span class="tabular-nums">{{ number_format($package['github_stars'], 0, '', ' ') }}</span>
    </span>
    <span>
        <x-elements.icon icon="fa-download" icon-style="fas" class="opacity-75" />
        <span class="tabular-nums">{{ number_format($package['downloads']['total'], 0, '', ' ') }}</span>
    </span>
    <span>
        <x-elements.icon icon="fa-link" icon-style="fas" class="opacity-75" />
        <span class="tabular-nums">{{ $package['dependents'] }}</span>
    </span>
    <span>
        <x-elements.icon icon="fa-user" icon-style="fas" class="opacity-75" />
    ...
    <span>
        <x-elements.icon icon="fa-tag" icon-style="fas" class="opacity-75" />
        {{ $version ?? 'dev-master' }}
    </span>
</div>
